            ...
            <div className="flex flex-col h-full justify-between">
                ...
                <div className="bg-black/40 border border-white/5 p-3 rounded-lg mb-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <Target className={`w-4 h-4 ${isReady ? 'text-green-400 animate-pulse' : 'text-zinc-500'}`} />
                        <div>
                            <p className="text-[10px] text-zinc-500 font-mono tracking-widest">ACTIVE TARGET</p>
